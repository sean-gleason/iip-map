...
class IIP_Map_Embed {
  ...
  public function iip_map_shortcode( $args ) {
    ...
    $html = '<div id="filter-group"><select id="topic-select"><option value="">-Select a topic-</option></select></div><div id="map" style="height: ' . $height . 'px" class="iip-map-container" data-map-id="' . $map . '"><div id="popup"></div></div><button id="toggle-table">View this map as a table</button><div id="event-list" class="hidden"></div>';
    return $html;
